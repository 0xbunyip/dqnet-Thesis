...
%Thông thường các mẫu thực nghiệm được tạo ra bằng chính sách thực hiện tham lam trên hàm giá trị hành động đang có hay nói cách khác trong quá trình lấy mẫu, tại mỗi trạng thái hệ thống ``gặp'', nó chỉ chọn thực hiện hành động có giá trị lớn nhất dựa trên hàm giá trị hiện tại. Một vấn đề có thể xảy ra của phương pháp lấy mẫu này là một số trạng thái sẽ không bao giờ xuất hiện trong quá trình lấy mẫu dẫn đến hệ thống có thể chỉ tìm ra được chính sách chỉ tối ưu trên tập những trạng thái đã ``gặp''. Ngược lại nếu không thực hiện tham lam trên hàm giá trị hành động, hệ thống sẽ khó khăn trong việc tìm lời 
%
